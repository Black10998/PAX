    ...
    $localize = array(
        ...
        'strings' => array(
            ...
            'liveagent' => array(
                ...
                'statusOffline' => __( 'You appear to be offline. Messages will be queued.', 'pax-support-pro' ),
                'statusReconnected' => __( 'Back online — resuming chat.', 'pax-support-pro' ),
    ...
    wp_localize_script(
        ...
        array(
            ...
            'strings'  => array(
                ...
                'reconnected' => __( 'Back online — resuming chat.', 'pax-support-pro' ),
                'typeHere'    => __( 'Type your message…', 'pax-support-pro' ),
                ...
                'rateChat'    => __( 'Rate chat', 'pax-support-pro' ),
                'submit'      => __( 'Submit', 'pax-support-pro' ),
                'startNewChat'=> __( 'Start a new chat', 'pax-support-pro' ),
