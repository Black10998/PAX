    ...
    if ( strpos( $hook, 'pax-live-agent-center' ) !== false ) {
        ...
        wp_localize_script(
            ...
            array(
                  'rest'   => array(
                      'base'        => $rest_base,
                      'sessions'    => $rest_base . 'live/sessions',
                      'session'     => $rest_base . 'live/session/',
                      'messages'    => $rest_base . 'live/messages',
                      'message'     => $rest_base . 'live/message',
                      'accept'      => $rest_base . 'live/accept',
                      'decline'     => $rest_base . 'live/decline',
                      'close'       => $rest_base . 'live/close',
                      'status'      => $rest_base . 'live/status',
                ...
                'user' => array(
                    ...
                    'strings' => array(
                        ...
                        'refreshLabel'     => __( 'Refresh', 'pax-support-pro' ),
                        'refreshComplete'  => __( 'Sessions updated', 'pax-support-pro' ),
                        'refreshFailed'    => __( 'Refresh failed. Please try again.', 'pax-support-pro' ),
                        'refreshing'       => __( 'Refreshing…', 'pax-support-pro' ),
                        'tooltipRefresh'   => __( 'Force sync sessions instantly. Auto-refresh runs every second while requests are pending.', 'pax-support-pro' ),
                        'tooltipPing'      => __( 'Runs a secure heartbeat against the REST API to confirm connectivity.', 'pax-support-pro' ),
                        'tooltipComposer'  => __( 'Use Shift+Enter for a new line. Messages send instantly with guaranteed delivery.', 'pax-support-pro' ),
                        'tooltipAccept'    => __( 'Assign this request to yourself and open the composer for real-time replies.', 'pax-support-pro' ),
                        'tooltipDecline'   => __( 'Politely close the request without responding — perfect for spam or duplicates.', 'pax-support-pro' ),
                        'tooltipClose'     => __( 'Wrap the conversation, prompt the visitor for a rating, and move it to Recent.', 'pax-support-pro' ),
                        'offlineNotice'    => __( 'Connection lost. We will retry automatically…', 'pax-support-pro' ),
                        'reconnected'      => __( 'Back online — sessions are up to date.', 'pax-support-pro' ),
                        'processing'       => __( 'Processing…', 'pax-support-pro' ),
                    ),
            )
        );
