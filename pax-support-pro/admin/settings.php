        ...
        wp_localize_script(
            ...
            array(
                ...
                'strings' => array(
                    ...
                    'acceptTooltip'   => __( 'Accept the chat and connect with the visitor instantly.', 'pax-support-pro' ),
                    'declineTooltip'  => __( 'Decline the request and move it to the Recent list.', 'pax-support-pro' ),
                    'closeTooltip'    => __( 'End the chat and prompt the visitor for a rating.', 'pax-support-pro' ),
                    'refreshing'      => __( 'Refreshing…', 'pax-support-pro' ),
                    'refreshed'       => __( 'Sessions updated.', 'pax-support-pro' ),
